...
\begin{itemize}
	\item[]
		...
		\item 
			Utilized networking protocols of TCP/IP communication in Linux to interface with an external peripheral to track eye-movement. Implemented for use in behavioral studies.
		\item 
...
\begin{itemize}
	\item[]
		\header
		{
			...
			{\textbf{Spring 2020}}
		\item 
			Used networking diagnostic tools such as wireshark to track packets sent/received using typical networking protocols, such as TCP/IP, ARP, DHCP, and QoS.
