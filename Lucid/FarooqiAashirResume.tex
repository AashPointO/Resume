...
\begin{itemize}
	\item[]
		...
		\item
			Independently brought up, prototyped, and developed a real-time solution to cross-reference external audio inputs with an EEG acquisition system by writing embedded firmware code in C leveraging my knowledge in Computer Architecture, Data Structures and Algorithms. Brought latency down from the previous iteration by a factor of 10. 
		\item 
		...
		\item 
			Implemented an external eye-tracking peripheral, by teaching myself the Networking protocols of TCP/IP communication in the scripting language of MATLAB and Python, for use in behavioral studies. 
		\item 
			Utilized Shell Scripting and the scripting language of MATLAB to optimize SW development and testing for an embedded system.
\end{itemize}
...
\begin{itemize}
	\item[]
		...
		\item
			Utilized knowledge in Data Structures, Algorithms, and object oriented software design principles, when converting the code base for an aircraft landing simulation from the scripting language of MATLAB to C++, bringing the runtime of the simulation down by a factor of 2. Despite tight time constraints and minimal assistance, I earned the "MVP" award for saving "hundreds of hours in simulation time and greatly reducing control system tuning efforts".
		\item
...
\begin{itemize}
	\item[]
		...
		\item 
			Wrote embedded firmware code in C, with peripheral interfacing using SPI, I2C, I2S, and UART, algonside the wireless technology of BLE, to track ambient noise, and cycle between different power modes for the SoC and peripherals.
