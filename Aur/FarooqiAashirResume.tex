...
\begin{itemize}
	\item[]
		...
		\item 
			Built a custom Linux distribution and cross-toolchains using the Yocto Project, by understanding both the architectural design of the target embedded system, alongside the architectural design of the host system.
		\item 
			Utilized Python scripting for tests in a Linux environment, alongside extensive amounts of hardware testing using lab equipment, such as Oscilloscopes, Logic Analyzers, Multimeters, and Function Generators.
\end{itemize}
...
\begin{itemize}
	\item[]
		...
		\item
			Wrote unit tests to validate the software simulation.
...
\begin{itemize}
	\item[]
		...
		\item 
			Brought up and assembled boards based on hardware requirements of the embedded system and external peripherals. Tested and validated the boards using typical lab equipment, such as Multimeters, Logic Analyzers, and Oscilloscopes.
