...
\begin{itemize}
	\item[]
		...
		\item 
			Implemented the REST API onto an embedded system to interact with my front-end website, which was built using a typical web technology stack of HTML/CSS, JavaScript, and Node.js.
...
\begin{itemize}
	\item[]
		...
		\item
			Originally designed around the React framework, before transitioning into the IOS native environment.
		\item
...
\begin{itemize}
	\item[]
		...
		\item
			Made as a response to the clunky end-user experience of similar tools on other websites, 
			and opted to use an algorithm which is scalable up to an arbitrary number of inputs, despite the added complexity of its implementation.
