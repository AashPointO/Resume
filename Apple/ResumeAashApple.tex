...
\begin{itemize}
	\item[]
		\items
			...
			{\textbf{Spring 2020}}
		\item
			Implemented multiple OS functionality right outside the kernel, such as writing a basic UNIX shell in C, preemptive scheduling of different processes, support for multi-threaded safe variables, and replicating an OS's management of a FAT16 file system.
		\item 
...
\begin{itemize}
	\item[]
		...
		\item 
			Refined skills in hardware debugging through use of multimeters, logic probes, and an oscilloscope 
		\item
