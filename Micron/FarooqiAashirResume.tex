...
\begin{itemize}
	\item[]
		...
		\item
			Independently brought up, prototyped, and developed a real-time solution to cross-reference external audio inputs with an EEG acquisition system
		...
		\item 
			Wrote exhaustive unit tests and maintained comprehensive documentation on all code I’ve written, and published using Git.
\end{itemize}
...
\begin{itemize}
	\item[]
		...
		\item 
			Utilized the Spritekit API to implement multi-tasking between detecting physics collisions between nodes, outputting custom made animations and sounds, and handling event-driven stimuli, such as user inputs.
		\item
