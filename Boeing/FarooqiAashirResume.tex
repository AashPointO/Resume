...
\begin{itemize}
	\item[]
		...
		\item
			Independently took the initiative to develop a real-time solution to cross-reference external audio inputs with an EEG acquisition system
		...
		\item 
			...
			behavioral studies.
		\item 
			Worked in Linux environment using git for version control and writing Bash scripts for occasional test script generation, 
			file management, and automation of tasks.
\end{itemize}
...
\begin{itemize}
	\item[]
		...
		\item
			...
			from MATLAB to C++, and leveraging algorithm design techniques. Despite tight time constraints and minimal instruction,
		...
		\item
			Validated my simulations by utilizing the Catch testing framework, incorporating a Test-Driven Development methodology, and utilizing 
	...
	\item[]
		\header
			{	
				...
				{\textbf{Winter 2018}}
		\item
			Implemented Quine-McCluskey algorithm in JavaScript to compute the \emph{Sum of Products} and \emph{Product of Sums} from a set of truth-table inputs.
