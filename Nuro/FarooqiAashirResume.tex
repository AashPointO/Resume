...
\begin{itemize}
	...
	\item 
		Configured the board bringup for a custom embedded Linux real-time OS and cross-toolchain using the Yocto Project, including configurations for a bootloader, operating system, and other optimizations based on the ARM-based SOC architecture. Gained insight on writing Linux kernel modules, IPC, and device drivers. 
	\item 
