...
\begin{itemize}
	\item[]
		...
		\item 
			Build custom embedded Linux distributions and cross-toolchains using the Yocto Project, by understanding the underlining hardware requirements of the target embedded system, and host system. 
\end{itemize}
